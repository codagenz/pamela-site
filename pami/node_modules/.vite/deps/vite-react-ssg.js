...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.a292c181.mjs
...
function Head(props) {
  return import_react2.default.createElement(W, { ...props });
}
function useIsClient() {
  const [isBrowser, setIsBrowser] = (0, import_react2.useState)(false);
...
Current type: ${(0, import_react2.isValidElement)(children) ? "React element" : typeof children}`
      );
    }
    return import_react2.default.createElement(import_react2.default.Fragment, null, children == null ? void 0 : children());
  }
  return fallback ?? null;
}

// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.579feabb.mjs
...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.054e813a.mjs
function joinUrlSegments(a2, b2) {
  if (!a2 || !b2)
    return a2 || b2 || "";
  if (a2[a2.length - 1] === "/")
...
// node_modules/vite-react-ssg/dist/index.mjs
var Link2 = (0, import_react3.forwardRef)((props, ref) => {
  const {
    replace,
    state,
    target,
  ...
  return import_react3.default.createElement(Link, { ...props, ref, onClick: handleClick });
});
Link2.displayName = "Link";
var NavLink2 = (0, import_react3.forwardRef)((props, ref) => {
  const {
    replace,
    state,
    target,
  ...
  return import_react3.default.createElement(NavLink, { ...props, ref, onClick: handleClick });
});
...
function ViteReactSSG(routerOptions, fn, options = {}) {
  ...
  if (isClient) {
    (async () => {
      ...
      const app = import_react3.default.createElement(q, null, import_react3.default.createElement(RouterProvider, { router }));
      ...
      if (!isSSR && true) {
        ...
        import_react3.default.startTransition(() => {
          (0, import_client.hydrateRoot)(container, app);
        });
      }
    })();
  }
